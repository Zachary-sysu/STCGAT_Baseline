...
trans_adj = get_adjacency_matrxix(dataset= 'PEMS08', number_nodes= 170)
frac_fltr = fractional_fltr(adj= trans_adj, number_nodes= 170, sigma= 0.5, gamma= 2.)

# sp.save_npz('PEMSD8_adj.npz', trans_adj)
sp.save_npz('PEMSD4_fltr.npz', frac_fltr)
