...
args.add_argument('--device', default=2, type=int, help='indices of GPUs')
...
#load dataset
train_loader, val_loader, test_loader, mean_, std_, times = get_dataloader_cde(args,
...
#start training
trainer = Trainer(model, vector_field_f, vector_field_g, loss, optimizer, train_loader, val_loader, test_loader, mean_, std_,
...
if args.mode == 'train':
    ...
    trainer.test(model, trainer.args, test_loader, mean_, std_, trainer.logger, None, times)
else:
    raise ValueError
